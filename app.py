#!/usr/bin/env python
"""DocGraph - Precision Markdown AST & Section Slicer Server Entrypoint."""
import sys
import argparse
from docgraph.server import create_app
from docgraph.constants import DEFAULT_HOST, DEFAULT_PORT

def main():
    parser = argparse.ArgumentParser(description="DocGraph - Precision Markdown Intelligence Server")
    ...
    print(f"===============================================================")
    print(f"   📄 DocGraph Server Running on http://{args.host}:{args.port}")
